...
public class Constantes {
    ...
    public static final String COPY_CANT_CLIENTES = "Cantidad de clientes permitidos";
    public static final String COPY_COSTO_ESPERA_CLIENTE = "Costo de espera del cliente";
    public static final String COPY_CANT_SERVIDORES = "Cantidad de servidores";
    public static final String COPY_COSTO_SERVIDOR = "Costo de cada servidor";
    
    public static final String COPY_TELL = "Tiempo entre llegadas";
    public static final String COPY_VALOR_TELL = "Valor del " + COPY_TELL.toLowerCase();
    public static final String COPY_PORCENTAJE_TELL = "Porcentaje del " + COPY_TELL.toLowerCase();
